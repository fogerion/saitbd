...
<body>
	...
	<div>
	    <img src="images/addcar.jpg" alt="forsajteam" width="800" height="600" class="addcar">
		<h2 style="position:relative;text-align:center;">Add new Car.</h2>
			<form action="add_car_form_action.php" method="post">
          		your car id: <input type="number" name="id_nomer">
          		  	<br>
				your name: <input type="text" name="fio">
          		  	<br>
				year of your car: <input type="number" name="god">
          		  	<br>
				brand: <input type="text" name="marka">
          		  	<br>
				<br>
